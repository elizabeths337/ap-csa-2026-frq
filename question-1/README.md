...
## *Part 1-a*
This question checks the availabilty of a username, and if the user requested username can be used.
...
If the inital user enter is available, then no modifications will be done.
